...
/**
 * This class stands for RespuestaExpedidaInmueblesType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaExpedidaInmueblesType extends AbstractStructBase
{
    /**
     * The IDFactura
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RespuestaExpedidaInmueblesType
     * @uses RespuestaExpedidaInmueblesType::setIDFactura()
     * @uses RespuestaExpedidaInmueblesType::setEstadoRegistro()
     * @uses RespuestaExpedidaInmueblesType::setCodigoErrorRegistro()
     * @uses RespuestaExpedidaInmueblesType::setDescripcionErrorRegistro()
     ...
     * Set IDFactura value
     * @param \ClonixDev\AeatSii\StructType\IDFacturaExpedidaBCType $iDFactura
     * @return \ClonixDev\AeatSii\StructType\RespuestaExpedidaInmueblesType
     */
