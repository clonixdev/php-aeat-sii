...
/**
 * This class stands for RespuestaMetalicoType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaMetalicoType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for RespuestaMetalicoType
     * @uses RespuestaMetalicoType::setPeriodoLiquidacion()
     * @uses RespuestaMetalicoType::setContraparte()
     * @uses RespuestaMetalicoType::setEstadoRegistro()
     * @uses RespuestaMetalicoType::setCodigoErrorRegistro()
     * @uses RespuestaMetalicoType::setDescripcionErrorRegistro()
     * @uses RespuestaMetalicoType::setCSV()
     * @uses RespuestaMetalicoType::setRegistroDuplicado()
     ...
     * @param \ClonixDev\AeatSii\StructType\PeriodoLiquidacion $periodoLiquidacion
     * @return \ClonixDev\AeatSii\StructType\RespuestaMetalicoType
     */
