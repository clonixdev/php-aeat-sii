...
class IDEmisorFactura extends AbstractStructBase
{
     ...
     * - base: string
     * - choice: NIF | IDOtro | NIF | IDOtro | NIF | IDOtro | NIF | IDOtro | NIF | IDOtro | NIF | IDOtro
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - length: 9
     ...
     * @param string $nombreRazon
     * @return \ClonixDev\AeatSii\StructType\IDEmisorFactura
     */
    ...
    public function setNIF($nIF = null)
    {
        ...
        // validation for constraint: choice(NIF, IDOtro, NIF, IDOtro, NIF, IDOtro, NIF, IDOtro, NIF, IDOtro, NIF, IDOtro)
