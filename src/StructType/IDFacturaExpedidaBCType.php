...
/**
 * This class stands for IDFacturaExpedidaBCType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura expedida para operaciones de baja y consulta
 * @subpackage Structs
 */
class IDFacturaExpedidaBCType extends AbstractStructBase
{
    /**
     * The IDEmisorFactura
    ...
    /**
     * Constructor method for IDFacturaExpedidaBCType
     * @uses IDFacturaExpedidaBCType::setIDEmisorFactura()
     * @uses IDFacturaExpedidaBCType::setNumSerieFacturaEmisor()
     * @uses IDFacturaExpedidaBCType::setFechaExpedicionFacturaEmisor()
     ...
     * @param \ClonixDev\AeatSii\StructType\IDEmisorFactura $iDEmisorFactura
     * @return \ClonixDev\AeatSii\StructType\IDFacturaExpedidaBCType
     */
