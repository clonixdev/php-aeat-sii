...
class RespuestaComunAltaType extends AbstractStructBase
{
     ...
     */
    public function __construct($cSV = null, \ClonixDev\AeatSii\StructType\DatosPresentacionType $datosPresentacion = null, \ClonixDev\AeatSii\StructType\CabeceraSii $cabecera = null, $estadoEnvio = null)
    {
        $this
            ->setCSV($cSV)
     ...
     * Set CSV value
     * @param string $cSV
     * @return \ClonixDev\AeatSii\StructType\RespuestaComunAltaType
     */
