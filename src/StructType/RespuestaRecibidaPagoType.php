...
/**
 * This class stands for RespuestaRecibidaPagoType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaRecibidaPagoType extends AbstractStructBase
{
    /**
     * The IDFactura
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RespuestaRecibidaPagoType
     * @uses RespuestaRecibidaPagoType::setIDFactura()
     * @uses RespuestaRecibidaPagoType::setEstadoRegistro()
     * @uses RespuestaRecibidaPagoType::setCodigoErrorRegistro()
     * @uses RespuestaRecibidaPagoType::setDescripcionErrorRegistro()
     ...
     */
    public function __construct(\ClonixDev\AeatSii\StructType\IDFacturaRecibidaNombreBCType $iDFactura = null, $estadoRegistro = null, $codigoErrorRegistro = null, $descripcionErrorRegistro = null)
    {
        $this
     ...
     * Set IDFactura value
     * @param \ClonixDev\AeatSii\StructType\IDFacturaRecibidaNombreBCType $iDFactura
     * @return \ClonixDev\AeatSii\StructType\RespuestaRecibidaPagoType
     */
