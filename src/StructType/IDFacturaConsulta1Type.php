...
/**
 * This class stands for IDFacturaConsulta1Type StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura
 * @subpackage Structs
 */
class IDFacturaConsulta1Type extends AbstractStructBase
{
    /**
     * The IDEmisorFactura
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for IDFacturaConsulta1Type
     * @uses IDFacturaConsulta1Type::setIDEmisorFactura()
     * @uses IDFacturaConsulta1Type::setNumSerieFacturaEmisor()
     * @uses IDFacturaConsulta1Type::setFechaExpedicionFacturaEmisor()
     ...
     * @param \ClonixDev\AeatSii\StructType\IDEmisorFactura $iDEmisorFactura
     * @return \ClonixDev\AeatSii\StructType\IDFacturaConsulta1Type
     */
