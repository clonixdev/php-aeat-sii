...
/**
 * This class stands for RespuestaExpedidaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaExpedidaType extends AbstractStructBase
{
    /**
     * The IDFactura
     * Meta information extracted from the WSDL
     ...
     * The CSV
     * Meta information extracted from the WSDL
     * - documentation: CSV asociado a la factura registrada previamente en el sistema. Solo se suministra si la factura enviada es rechazada por estar duplicada
     * - minOccurs: 0
     * @var string
     */
    public $CSV;
    ...
    /**
     * Constructor method for RespuestaExpedidaType
     * @uses RespuestaExpedidaType::setIDFactura()
     * @uses RespuestaExpedidaType::setRefExterna()
     * @uses RespuestaExpedidaType::setEstadoRegistro()
     * @uses RespuestaExpedidaType::setCodigoErrorRegistro()
     * @uses RespuestaExpedidaType::setDescripcionErrorRegistro()
     * @uses RespuestaExpedidaType::setCSV()
     * @uses RespuestaExpedidaType::setRegistroDuplicado()
     ...
     */
    public function __construct(\ClonixDev\AeatSii\StructType\IDFacturaExpedidaType $iDFactura = null, $refExterna = null, $estadoRegistro = null, $codigoErrorRegistro = null, $descripcionErrorRegistro = null, $cSV = null, \ClonixDev\AeatSii\StructType\RegistroDuplicadoType $registroDuplicado = null)
    {
        $this
     ...
     * Set IDFactura value
     * @param \ClonixDev\AeatSii\StructType\IDFacturaExpedidaType $iDFactura
     * @return \ClonixDev\AeatSii\StructType\RespuestaExpedidaType
     */
