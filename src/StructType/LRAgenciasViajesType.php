...
/**
 * This class stands for LRAgenciasViajesType StructType
 * Meta information extracted from the WSDL
 * - documentation: Apunte correspondiente a importes agencias viajes.
 * @subpackage Structs
 */
class LRAgenciasViajesType extends RegistroSii
{
    /**
     * The Contraparte
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for LRAgenciasViajesType
     * @uses LRAgenciasViajesType::setContraparte()
     * @uses LRAgenciasViajesType::setImporteTotal()
     * @uses LRAgenciasViajesType::setEntidadSucedida()
     ...
     * @param \ClonixDev\AeatSii\StructType\PersonaFisicaJuridicaType $contraparte
     * @return \ClonixDev\AeatSii\StructType\LRAgenciasViajesType
     */
