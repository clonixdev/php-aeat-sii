...
/**
 * This class stands for IDFacturaARType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura agrupada o rectificada. El NIF se cogerá del NIF indicado en el bloque IDFactura
 * @subpackage Structs
 */
class IDFacturaARType extends AbstractStructBase
{
    /**
     * The NumSerieFacturaEmisor
     * Meta information extracted from the WSDL
     * - documentation: Nº Serie+Nº Factura de la factura
     * - base: string
     * - maxLength: 60
     * - minLength: 1
     * @var string
     ...
     * Meta information extracted from the WSDL
     * - documentation: Fecha de emisión de la factura agrupada o rectificada
     * - base: string
     * - length: 10
    ...
    /**
     * Constructor method for IDFacturaARType
     * @uses IDFacturaARType::setNumSerieFacturaEmisor()
     * @uses IDFacturaARType::setFechaExpedicionFacturaEmisor()
     ...
     * @param string $numSerieFacturaEmisor
     * @return \ClonixDev\AeatSii\StructType\IDFacturaARType
     */
