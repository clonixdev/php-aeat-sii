...
/**
 * This class stands for RespuestaBienBajaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaBienBajaType extends AbstractStructBase
{
    /**
    ...
    public $CSV;
    /**
     * Constructor method for RespuestaBienBajaType
     * @uses RespuestaBienBajaType::setPeriodoLiquidacion()
     * @uses RespuestaBienBajaType::setIDFactura()
     * @uses RespuestaBienBajaType::setIdentificacionBien()
     * @uses RespuestaBienBajaType::setRefExterna()
     * @uses RespuestaBienBajaType::setEstadoRegistro()
     * @uses RespuestaBienBajaType::setCodigoErrorRegistro()
     * @uses RespuestaBienBajaType::setDescripcionErrorRegistro()
     * @uses RespuestaBienBajaType::setCSV()
     ...
     * @param string $cSV
     */
    public function __construct(\ClonixDev\AeatSii\StructType\PeriodoLiquidacion $periodoLiquidacion = null, \ClonixDev\AeatSii\StructType\IDFacturaComunitariaType $iDFactura = null, $identificacionBien = null, $refExterna = null, $estadoRegistro = null, $codigoErrorRegistro = null, $descripcionErrorRegistro = null, $cSV = null)
    {
        $this
     ...
     * @param \ClonixDev\AeatSii\StructType\PeriodoLiquidacion $periodoLiquidacion
     * @return \ClonixDev\AeatSii\StructType\RespuestaBienBajaType
     */
