...
/**
 * This class stands for IDFacturaRecibidaNombreBCType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura recibida
 * @subpackage Structs
 */
class IDFacturaRecibidaNombreBCType extends AbstractStructBase
{
    /**
     * The IDEmisorFactura
     ...
     * Meta information extracted from the WSDL
     * - documentation: Nº Serie+Nº Factura de la Factura del Emisor. En caso de asientos resúmenes Nº Serie+Nº Factura inicial de factura
     * - base: string
     * - maxLength: 60
     * - minLength: 1
     * @var string
    ...
    /**
     * Constructor method for IDFacturaRecibidaNombreBCType
     * @uses IDFacturaRecibidaNombreBCType::setIDEmisorFactura()
     * @uses IDFacturaRecibidaNombreBCType::setNumSerieFacturaEmisor()
     * @uses IDFacturaRecibidaNombreBCType::setFechaExpedicionFacturaEmisor()
     ...
     * @param \ClonixDev\AeatSii\StructType\IDEmisorFactura $iDEmisorFactura
     * @return \ClonixDev\AeatSii\StructType\IDFacturaRecibidaNombreBCType
     */
