...
/**
 * This class stands for IDFacturaExpedidaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura
 * @subpackage Structs
 */
class IDFacturaExpedidaType extends AbstractStructBase
{
    /**
     * The IDEmisorFactura
     ...
     * Meta information extracted from the WSDL
     * - documentation: Nº Serie+Nº Factura de la Factura del Emisor. En caso de asientos resúmenes número inicial de factura
     * - base: string
     * - maxLength: 60
     * - minLength: 1
     * @var string
    ...
    /**
     * Constructor method for IDFacturaExpedidaType
     * @uses IDFacturaExpedidaType::setIDEmisorFactura()
     * @uses IDFacturaExpedidaType::setNumSerieFacturaEmisor()
     * @uses IDFacturaExpedidaType::setNumSerieFacturaEmisorResumenFin()
     * @uses IDFacturaExpedidaType::setFechaExpedicionFacturaEmisor()
     ...
     * @param \ClonixDev\AeatSii\StructType\IDEmisorFactura $iDEmisorFactura
     * @return \ClonixDev\AeatSii\StructType\IDFacturaExpedidaType
     */
