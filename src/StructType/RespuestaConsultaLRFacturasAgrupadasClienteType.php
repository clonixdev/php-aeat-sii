...
/**
 * This class stands for RespuestaConsultaLRFacturasAgrupadasClienteType StructType
 * @subpackage Structs
 */
class RespuestaConsultaLRFacturasAgrupadasClienteType extends ConsultaInformacionCliente
{
    /**
    ...
    /**
     * Constructor method for RespuestaConsultaLRFacturasAgrupadasClienteType
     * @uses RespuestaConsultaLRFacturasAgrupadasClienteType::setResultadoConsulta()
     ...
     * @param string $resultadoConsulta
     * @return \ClonixDev\AeatSii\StructType\RespuestaConsultaLRFacturasAgrupadasClienteType
     */
