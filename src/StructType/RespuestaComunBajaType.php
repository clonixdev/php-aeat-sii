...
/**
 * This class stands for RespuestaComunBajaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii de baja
 * @subpackage Structs
 */
class RespuestaComunBajaType extends AbstractStructBase
{
    /**
     * The CSV
     * Meta information extracted from the WSDL
    ...
    public $EstadoEnvio;
    /**
     * Constructor method for RespuestaComunBajaType
     * @uses RespuestaComunBajaType::setCSV()
     * @uses RespuestaComunBajaType::setDatosPresentacion()
     * @uses RespuestaComunBajaType::setCabecera()
     * @uses RespuestaComunBajaType::setEstadoEnvio()
     * @param string $cSV
     ...
     */
    public function __construct($cSV = null, \ClonixDev\AeatSii\StructType\DatosPresentacionType $datosPresentacion = null, \ClonixDev\AeatSii\StructType\CabeceraSiiBaja $cabecera = null, $estadoEnvio = null)
    {
        $this
            ->setCSV($cSV)
     ...
     * Set CSV value
     * @param string $cSV
     * @return \ClonixDev\AeatSii\StructType\RespuestaComunBajaType
     */
