...
/**
 * This class stands for RespuestaRecibidaBajaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaRecibidaBajaType extends AbstractStructBase
{
    /**
     * The IDFactura
     * Meta information extracted from the WSDL
    ...
    public $CSV;
    /**
     * Constructor method for RespuestaRecibidaBajaType
     * @uses RespuestaRecibidaBajaType::setIDFactura()
     * @uses RespuestaRecibidaBajaType::setRefExterna()
     * @uses RespuestaRecibidaBajaType::setEstadoRegistro()
     * @uses RespuestaRecibidaBajaType::setCodigoErrorRegistro()
     * @uses RespuestaRecibidaBajaType::setDescripcionErrorRegistro()
     * @uses RespuestaRecibidaBajaType::setCSV()
     ...
     * @param string $cSV
     */
    public function __construct(\ClonixDev\AeatSii\StructType\IDFacturaRecibidaNombreBCType $iDFactura = null, $refExterna = null, $estadoRegistro = null, $codigoErrorRegistro = null, $descripcionErrorRegistro = null, $cSV = null)
    {
        $this
     ...
     * Set IDFactura value
     * @param \ClonixDev\AeatSii\StructType\IDFacturaRecibidaNombreBCType $iDFactura
     * @return \ClonixDev\AeatSii\StructType\RespuestaRecibidaBajaType
     */
