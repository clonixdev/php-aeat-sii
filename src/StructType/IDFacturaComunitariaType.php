...
/**
 * This class stands for IDFacturaComunitariaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura
 * @subpackage Structs
 */
class IDFacturaComunitariaType extends AbstractStructBase
{
    /**
     * The IDEmisorFactura
    ...
    /**
     * Constructor method for IDFacturaComunitariaType
     * @uses IDFacturaComunitariaType::setIDEmisorFactura()
     * @uses IDFacturaComunitariaType::setNumSerieFacturaEmisor()
     * @uses IDFacturaComunitariaType::setFechaExpedicionFacturaEmisor()
     ...
     * @param \ClonixDev\AeatSii\StructType\IDEmisorFactura $iDEmisorFactura
     * @return \ClonixDev\AeatSii\StructType\IDFacturaComunitariaType
     */
