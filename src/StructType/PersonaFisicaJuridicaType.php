...
/**
 * This class stands for PersonaFisicaJuridicaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de una persona física o jurídica Española o Extranjera
 * @subpackage Structs
 */
class PersonaFisicaJuridicaType extends AbstractStructBase
{
    /**
     * The NombreRazon
     * Meta information extracted from the WSDL
    ...
    public $IDOtro;
    /**
     * Constructor method for PersonaFisicaJuridicaType
     * @uses PersonaFisicaJuridicaType::setNombreRazon()
     * @uses PersonaFisicaJuridicaType::setNIFRepresentante()
     * @uses PersonaFisicaJuridicaType::setNIF()
     * @uses PersonaFisicaJuridicaType::setIDOtro()
     * @param string $nombreRazon
     * @param string $nIFRepresentante
     * @param string $nIF
     * @param \ClonixDev\AeatSii\StructType\IDOtroType $iDOtro
     */
    public function __construct($nombreRazon = null, $nIFRepresentante = null, $nIF = null, \ClonixDev\AeatSii\StructType\IDOtroType $iDOtro = null)
    {
        $this
     ...
     * @param string $nombreRazon
     * @return \ClonixDev\AeatSii\StructType\PersonaFisicaJuridicaType
     */
