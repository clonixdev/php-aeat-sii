...
/**
 * This class stands for RespuestaAgenciasViajesBajaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaAgenciasViajesBajaType extends AbstractStructBase
{
    /**
    ...
    public $CSV;
    /**
     * Constructor method for RespuestaAgenciasViajesBajaType
     * @uses RespuestaAgenciasViajesBajaType::setPeriodoLiquidacion()
     * @uses RespuestaAgenciasViajesBajaType::setContraparte()
     * @uses RespuestaAgenciasViajesBajaType::setEstadoRegistro()
     * @uses RespuestaAgenciasViajesBajaType::setCodigoErrorRegistro()
     * @uses RespuestaAgenciasViajesBajaType::setDescripcionErrorRegistro()
     * @uses RespuestaAgenciasViajesBajaType::setCSV()
     ...
     * @param string $cSV
     */
    public function __construct(\ClonixDev\AeatSii\StructType\PeriodoLiquidacion $periodoLiquidacion = null, \ClonixDev\AeatSii\StructType\PersonaFisicaJuridicaType $contraparte = null, $estadoRegistro = null, $codigoErrorRegistro = null, $descripcionErrorRegistro = null, $cSV = null)
    {
        $this
     ...
     * @param \ClonixDev\AeatSii\StructType\PeriodoLiquidacion $periodoLiquidacion
     * @return \ClonixDev\AeatSii\StructType\RespuestaAgenciasViajesBajaType
     */
