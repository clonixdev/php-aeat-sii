...
/**
 * This class stands for IDFacturaRecibidaNombreType StructType
 * Meta information extracted from the WSDL
 * - documentation: Datos de identificación de factura
 * @subpackage Structs
 */
class IDFacturaRecibidaNombreType extends AbstractStructBase
{
    /**
     * The IDEmisorFactura
    ...
    /**
     * Constructor method for IDFacturaRecibidaNombreType
     * @uses IDFacturaRecibidaNombreType::setIDEmisorFactura()
     * @uses IDFacturaRecibidaNombreType::setNumSerieFacturaEmisor()
     * @uses IDFacturaRecibidaNombreType::setNumSerieFacturaEmisorResumenFin()
     * @uses IDFacturaRecibidaNombreType::setFechaExpedicionFacturaEmisor()
     ...
     * @param \ClonixDev\AeatSii\StructType\IDEmisorFactura $iDEmisorFactura
     * @return \ClonixDev\AeatSii\StructType\IDFacturaRecibidaNombreType
     */
