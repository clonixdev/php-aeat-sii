...
/**
 * This class stands for RespuestaComunitariaBajaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Respuesta a un envío Sii
 * @subpackage Structs
 */
class RespuestaComunitariaBajaType extends AbstractStructBase
{
    /**
     * The IDFactura
     * Meta information extracted from the WSDL
    ...
    public $CSV;
    /**
     * Constructor method for RespuestaComunitariaBajaType
     * @uses RespuestaComunitariaBajaType::setIDFactura()
     * @uses RespuestaComunitariaBajaType::setRefExterna()
     * @uses RespuestaComunitariaBajaType::setEstadoRegistro()
     * @uses RespuestaComunitariaBajaType::setCodigoErrorRegistro()
     * @uses RespuestaComunitariaBajaType::setDescripcionErrorRegistro()
     * @uses RespuestaComunitariaBajaType::setCSV()
     ...
     * @param string $cSV
     */
    public function __construct(\ClonixDev\AeatSii\StructType\IDFacturaComunitariaType $iDFactura = null, $refExterna = null, $estadoRegistro = null, $codigoErrorRegistro = null, $descripcionErrorRegistro = null, $cSV = null)
    {
        $this
     ...
     * Set IDFactura value
     * @param \ClonixDev\AeatSii\StructType\IDFacturaComunitariaType $iDFactura
     * @return \ClonixDev\AeatSii\StructType\RespuestaComunitariaBajaType
     */
